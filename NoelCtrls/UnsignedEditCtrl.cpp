...
IMPLEMENT_OLECREATE_EX(UnsignedEditCtrl, "NoelCtrls.UnsignedEditCtrl", 0xd88f010F, 0x321c, 0x11d3, 0x87, 0x6, 0xe7, 0x54, 0x9f, 0x7f, 0x7d, 0x3c) // Initialize class factory and guid
...
/**
 Method  : BOOL UnsignedEditCtrl::UnsignedEditCtrlFactory::VerifyUserLicense()
 Purpose : Verify if the user as a licence to use
           the UnsignedEdit control for designing.
 Version : 1.0.0
*/
BOOL UnsignedEditCtrl::UnsignedEditCtrlFactory::VerifyUserLicense() {
	return AfxVerifyLicFile(AfxGetInstanceHandle(), _szLicFileName, _szLicString);
}

/**
 Method  : BOOL UnsignedEditCtrl::UnsignedEditCtrlFactory::GetLicenseKey(DWORD dwReserved,	BSTR FAR* pbstrKey)
 Purpose : Requests a unique license key from the control’s DLL 
           and stores it in the BSTR pointed to by pbstrKey.
 Version : 1.0.0
*/
BOOL UnsignedEditCtrl::UnsignedEditCtrlFactory::GetLicenseKey(DWORD dwReserved,	BSTR FAR* pbstrKey) {
